...
class MessagesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @message.save
        ...
        format.html { render action: :new, error: @message.errors.messages }
  ...
  def update
    @message = @channel.messages.find(params[:id])
    @message = MessageFactoryService
      .new(message_params, params, message: @message, channel: nil)
      .message
  ...
  def import
    ...
    if resp[:completed]
      redirect_to request.referer, notice: "Messages imported"
    else
